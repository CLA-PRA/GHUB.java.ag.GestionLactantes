...
public class ArbolAVL  {
	...
	public void insertar2(Object valor) throws Exception{
		ComparableMujer dato = (ComparableMujer) valor;
		Nodo nuevo = new Nodo();
		nuevo.setValor(dato);
	 ...
	 * @throws Exception
	 */
	private Nodo insertarAVL(Nodo raiz, ComparableMujer dt, Logical h) throws Exception{
		Nodo n1;
		if (raiz == null) {
	...
	public Nodo buscar2(Object buscado) {
		ComparableMujer dato = (ComparableMujer)buscado;
		if (raiz ==null)
			return null;
		else
	...
	public Nodo localizar(Nodo raizSub, ComparableMujer buscado) {
		if (raizSub ==null)
			return null;
	...
	public void eliminar(Object valor) throws Exception{
		ComparableMujer dato;
		dato = (ComparableMujer) valor;
	...
	public Nodo borrarAVL(Nodo r, ComparableMujer clave, Logical cambioAltura) 
			throws Exception{
		if(r==null) {
